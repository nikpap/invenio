...
define(
  ...
  function(
    ...
    *
    * :param string delete_url: URL endpoint to deleting the object
    * :param string restart_url: URL endpoint to restarting the object workflow
    * :param string id_object: id of current workflow object
    *
    */
